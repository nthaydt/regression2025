...
sitee_top1<- glmer(Use ~ PerchH5 + Water11 + 
                 (1|PointID) + (1|BirdID), family = binomial, data = Habitat)

sitee_top2<- glmer(Use ~ Crops11 + PerchH5 + Water11 + 
...
confint(sitee_top1,level=0.85, method="Wald")
confint(sitee_top2,level=0.85, method="Wald")
...
plot_model(sitee_top1, type = "pred", terms = "Water11")
plot_model(sitee_top1, type = "pred", terms="PerchH5 [all]") #[all ensures smooth plot]
...
predicted_values <- predict(sitee_top1, type = "response")
