...
##Generalized Linear Mixed Model (Shrike Data)
# Look at correlations between predictors
```{r}
# Shrikes: Rescale Wire Length since we have much larger values (i.e. 1000 m) when compared to other variables
...
# Look at correlations between predictors for Fine-scale characteristics
```{r}
...
## Build Models for Fine-scale level characteristics
```{r}
# Build full model with all variables of interest
...
##Plot Tops Models for Fine-Scale Characteristics
```{r}
...
## Look at correlations between predictors for Broad-scale characteristics
...
## Build Full Model for Broad-Scale Characteristics
```{r}
#Build full model with all variables of interest
...
## Build Top Models for Broad-Scale Characteristics
```{r}
# Build top models (delta AICc<2) from dredge table output --> print(model_set1)
...
## Plot Model Broad-scale characteristics
```{r}
#Model plots to visualize correlation trends
